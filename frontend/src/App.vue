  ...
  <div class="min-h-screen bg-gray-50">
    <nav class="bg-green-600 p-4 text-white flex justify-between items-center shadow-md">
      <div class="flex gap-6">
        ...
        <router-link v-if="isAuthenticated" to="/ingredients" class="hover:underline">Ingredients</router-link>
        <router-link v-if="isAuthenticated" to="/recipes" class="hover:underline">Recipes</router-link>
        <router-link v-if="isAuthenticated" to="/shopping-lists" class="hover:underline">Shopping Lists</router-link>
      </div>
